...
class GalleryCafeCreationForm(ModelForm):
    ...
    image2 = forms.ImageField(label='', required=True)
    image3 = forms.ImageField(label='', required=True)
    image4 = forms.ImageField(label='', required=True)
    ...
    class Meta:
        model = GalleryCafe
        fields = ['image1', 'image2', 'image3', 'image4', 'name', 'location', 'phone_number', 'start_date', 'end_date',
                  'content']